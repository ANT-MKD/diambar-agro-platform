...
const RULES: TriggerRule[] = [
  { key: "r1", label: "Mission proche", condition: "Pickup à moins de 5 km", channel: "In-app + SMS", firedThisMonth: 31 },
  { key: "r2", label: "Mission bien rémunérée", condition: "Gain > 10 000 FCFA", channel: "In-app + WhatsApp", firedThisMonth: 8 },
  { key: "r3", label: "Versement Wave", condition: "Retrait validé", channel: "SMS + In-app", firedThisMonth: 4 },
  { key: "r4", label: "Assurance à renouveler", condition: "Expiration < 30 jours", channel: "Email", firedThisMonth: 1 },
];
      ...
      <PageHeader
        ...
        actions={
          <Button asChild variant="outline" className="gap-2">
            <Link to="/driver/notifications"><ArrowLeft className="h-4 w-4" />Retour</Link>
          </Button>
        }
      />
