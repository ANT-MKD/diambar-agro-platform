...
export const Route = createFileRoute("/farmer/settings/team")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Invitez vos collaborateurs et gérez leurs rôles sur votre exploitation." },
...
function TeamSettings() {
  const [members, setMembers] = useState<Member[]>([
    { id: "t1", name: "Mamadou Diallo", email: "mamadou@diallo-farm.sn", role: "owner", status: "active" },
