  ...
  head: () => ({
    meta: [
      { title: "Devenir livreur partenaire | Diambar Agro" },
      {
        name: "description",
        content:
          "Choisissez vos missions de livraison alimentaire au Sénégal, gardez 80 % de la course et soyez payé le jour même.",
      },
      { property: "og:title", content: "Devenir livreur partenaire — Diambar Agro" },
      {
        property: "og:description",
        content: "Missions à la demande, 80 % de la course, paiement journalier.",
      },
      { property: "og:type", content: "website" },
      {
        property: "og:image",
        content: "https://images.unsplash.com/photo-1601758174039-4ed7a4d2c0bd?w=1200",
      },
      ...
      benefits={[
        {
          ...
          desc: "Passez en ligne quand vous voulez, refusez une mission sans pénalité.",
        },
        {
          icon: Banknote,
          title: "Revenus clairs",
          desc: "Gains par mission, bonus de performance et historique consultable.",
        },
        {
          icon: RouteIcon,
          title: "Itinéraires optimisés",
          desc: "Missions regroupées par corridor pour maximiser vos gains horaires.",
        },
        {
          icon: ShieldCheck,
          title: "Assurance incluse",
          desc: "Chaque mission acceptée est couverte pendant toute la livraison.",
        },
      ]}
      steps={[
