...
export const Route = createFileRoute("/driver/disputes/")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Incidents de course et litiges livreur : statut, indemnité demandée, délais." },
  ...
  component: () => {
    ...
    return <DisputeListView disputes={disputes} role="driver" detailPath="/driver/disputes/$disputeId" title="Mes litiges & incidents" />;
  },
});
