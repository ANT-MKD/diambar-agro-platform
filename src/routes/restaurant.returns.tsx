  ...
  head: () => ({
    meta: [
      { title: "Retours & avoirs — Espace restaurant Diambar Agro" },
      {
        name: "description",
        content:
          "Déclarez un retour produit sur une commande livrée et suivez les avoirs obtenus auprès de vos producteurs.",
      },
      { property: "og:title", content: "Retours & avoirs — Espace restaurant" },
      {
        property: "og:description",
        content: "Déclaration de retours produits et suivi des avoirs.",
      },
...
function RestaurantReturnsPage() {
  ...
  const [form, setForm] = useState({
    ...
    qty: "",
    unit: "kg",
    reason: "quality" as ReturnReason,
    description: "",
    requestedAmount: "",
  });
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Déclarez un problème sur une livraison et suivez vos avoirs"
      />
      ...
      <div className="glass rounded-2xl p-5 space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="space-y-1 sm:col-span-2">
            ...
            <Textarea
              placeholder="Décrivez le problème constaté à la réception…"
            ...
            <div key={r.id} className="glass rounded-2xl p-4">
              ...
              {r.creditNoteRef && (
                <p className="mt-1 text-xs">
                  Avoir reçu <span className="font-mono">{r.creditNoteRef}</span> —{" "}
                  {formatFCFA(r.awardedAmount ?? 0)}
                </p>
              )}
            </div>
          ))
