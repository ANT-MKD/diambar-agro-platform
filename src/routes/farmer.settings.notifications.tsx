  ...
  head: () => ({
    meta: [
      { title: "Notifications · Paramètres agriculteur · Diambar Agro" },
      {
        name: "description",
        content:
          "Choisissez les alertes commandes, paiements et stock que vous souhaitez recevoir.",
      },
...
const EVENTS = [
  {
    ...
    description: "Alerte immédiate à chaque commande reçue",
  },
  {
    key: "payments",
    label: "Paiements reçus",
    description: "Confirmation de versement sur votre wallet",
  },
  {
    key: "stock",
    label: "Stock faible",
    description: "Quand un produit passe sous le seuil minimum",
  },
  {
    key: "messages",
    label: "Nouveaux messages",
    description: "Messages des restaurants partenaires",
  },
  {
    key: "marketing",
    label: "Offres et nouveautés",
    description: "Conseils, nouveautés produits Diambar",
  },
] as const;
