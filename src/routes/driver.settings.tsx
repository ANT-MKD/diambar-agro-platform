          ...
          <div className="glass rounded-2xl p-5">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              {[
                ...
                <button
                  key={v}
                  className={`rounded-xl border p-3 text-sm font-medium transition ${v === "weekly" ? "border-primary bg-primary/10 text-primary" : "border-border hover:bg-accent"}`}
                >
                  {l}
                </button>
              ))}
          ...
          <div className="glass rounded-2xl p-5">
            ...
            <div className="mt-3 flex flex-col gap-2">
              <Button
                ...
                onClick={() => toast.info("Fonction non disponible en démo")}
              >
