  ...
  head: () => ({
    meta: [
      { title: "Notations fournisseurs — Espace restaurant Diambar Agro" },
      {
        name: "description",
        content:
          "Notez vos livraisons (qualité, ponctualité, emballage) et consultez le scoring de vos producteurs partenaires.",
      },
      { property: "og:title", content: "Notations fournisseurs — Espace restaurant" },
      {
        property: "og:description",
        content: "Notez vos livraisons et suivez le scoring de vos producteurs.",
      },
    ...
    <div className="mt-3 space-y-3 rounded-xl border border-border p-3">
      <div className="grid gap-2 sm:grid-cols-3">
        <div className="space-y-1">
          <div className="text-xs text-muted-foreground">Qualité produits</div>
        ...
        <div className="space-y-1">
          <div className="text-xs text-muted-foreground">Emballage</div>
          <Stars value={packaging} onChange={setPackaging} />
        </div>
      </div>
      <Textarea
      ...
      <Button
        ...
        onClick={() => {
          ...
          toast.success("Merci pour votre note", {
            description: `${supplierName} · ${((quality + delivery + packaging) / 3).toFixed(1)}/5`,
          });
        }}
      >
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Évaluez vos livraisons et suivez le scoring de vos producteurs"
      />
          ...
          toRate.map((o) => (
            <div key={o.id} className="glass rounded-2xl p-4">
              ...
              <RatingForm
                ...
                supplierId={o.farmerId}
                supplierName={supplierName(o.farmerId)}
              />
            </div>
          ))
        )}
          ...
          reviews.map((r) => (
            <div key={r.id} className="glass rounded-2xl p-4 space-y-2">
              ...
              <div className="flex flex-wrap gap-3 text-[11px] text-muted-foreground">
                ...
                <span>Ponctualité {r.delivery}/5</span>
                <span>Emballage {r.packaging}/5</span>
              </div>
