...
function ValidationDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        title={`Dossier ${user?.name ?? v.userId}`}
        subtitle={`Déposé ${relativeTime(v.submittedAt)}`}
        actions={
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="glass rounded-2xl p-5 space-y-3">
          ...
          <textarea
            ...
            rows={4}
            placeholder="Motif ou commentaire interne…"
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button
              ...
              onClick={() => {
                validationActions.reject(v.id, note || undefined);
