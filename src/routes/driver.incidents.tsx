    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="glass rounded-2xl p-4">
          <div className="text-xs text-muted-foreground">Incidents en cours</div>
          <div className="mt-1 text-2xl font-bold">{open}</div>
        </div>
        <div className="glass rounded-2xl p-4">
          <div className="text-xs text-muted-foreground">Indemnités obtenues</div>
          <div className="mt-1 text-2xl font-bold">{formatFCFA(awarded)}</div>
        </div>
        <div className="glass rounded-2xl p-4">
          <div className="text-xs text-muted-foreground">Total déclarés</div>
          <div className="mt-1 text-2xl font-bold">{incidents.length}</div>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-5 space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="space-y-1">
            ...
            <Input
              placeholder="MIS-4210"
              value={form.missionRef}
              onChange={(e) => setForm({ ...form, missionRef: e.target.value })}
            />
          </div>
          <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <div className="mt-1 text-xs text-muted-foreground">
                    {i.missionRef} · {INCIDENT_TYPE_LABEL[i.type]} · attente {i.waitedMinutes} min ·{" "}
