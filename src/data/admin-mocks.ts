...
export const disputes: Dispute[] = [
  {
    ...
    status: "open",
    priority: "high",
    openedAt: "2025-05-15T09:40:00Z",
    timeline: [
      {
        at: "2025-05-15T09:40:00Z",
        actor: "Le Baobab",
        text: "Ouverture du litige avec photos jointes.",
      },
    ],
  },
  {
    ...
    priority: "medium",
    openedAt: "2025-05-14T13:05:00Z",
    timeline: [
      { at: "2025-05-14T13:05:00Z", actor: "Hôtel Téranga", text: "Ouverture du litige." },
      {
        at: "2025-05-14T15:00:00Z",
        actor: "Support Diambar",
        text: "Prise en charge, demande de traces GPS au livreur.",
      },
    ],
  },
  {
    ...
    reference: "LIT-0140",
    orderRef: "CMD-2829",
    openedBy: "Chez Aminata",
    against: "Ferme Diallo",
    reason: "Colis manquant",
    description: "Un sac de 10 kg d'oignons manquant sur la commande.",
    amount: 4500,
    status: "resolved",
    priority: "low",
    openedAt: "2025-05-10T11:00:00Z",
    timeline: [
      { at: "2025-05-10T11:00:00Z", actor: "Chez Aminata", text: "Ouverture du litige." },
      {
        at: "2025-05-10T16:30:00Z",
        actor: "Support Diambar",
        text: "Remboursement de 4 500 FCFA validé.",
      },
      { at: "2025-05-11T08:00:00Z", actor: "Système", text: "Litige clôturé automatiquement." },
    ],
  },
  {
    id: "dp4",
    reference: "LIT-0139",
    orderRef: "CMD-2820",
    openedBy: "Dibiterie Keur Massar",
    against: "Plateforme",
    reason: "Litige de paiement",
    description: "Double débit Orange Money signalé par le restaurant.",
    amount: 73000,
    status: "rejected",
    priority: "medium",
    openedAt: "2025-05-08T10:15:00Z",
    timeline: [
      { at: "2025-05-08T10:15:00Z", actor: "Dibiterie Keur Massar", text: "Ouverture du litige." },
      {
        at: "2025-05-09T09:00:00Z",
        actor: "Support Diambar",
        text: "Un seul débit confirmé par l'opérateur — litige rejeté.",
      },
    ],
  },
];
