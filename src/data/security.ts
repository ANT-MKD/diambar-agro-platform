...
const initial: SecurityState = {
  ...
  logins: [
    ...
    {
      id: "l3",
      at: "2025-05-13T22:07:00Z",
      device: "Inconnu · Linux",
      ip: "102.64.8.71",
      place: "Abidjan",
      result: "failed",
    },
...
export const securityActions = {
  ...
  regenerateCodes: () =>
    set((s) => ({ ...s, recoveryCodes: Array.from({ length: 6 }, randomCode) })),
