  ...
  return (
    <Link to="/" className={`group inline-flex items-center gap-2 ${className}`}>
      ...
      <span className="flex flex-col leading-none">
        <span className="font-display text-lg font-bold tracking-tight">DIAMBAR <span className="text-gradient-emerald">AGRO</span></span>
        {showTag && <span className="text-[10px] uppercase tracking-widest text-muted-foreground mt-0.5">Du Champ à Votre Cuisine</span>}
      </span>
    </Link>
  );
}
