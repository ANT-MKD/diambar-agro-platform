    ...
    <section className="py-24 bg-card/30">
      <div className="mx-auto max-w-7xl px-4">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <p className="text-emerald-500 font-semibold text-sm uppercase tracking-wider">Suivi en direct</p>
          <h2 className="mt-3 font-display text-4xl lg:text-5xl font-bold">Suivez votre livraison en temps réel</h2>
        </div>
        <div className="grid lg:grid-cols-3 gap-6 items-stretch">
          <div className="lg:col-span-2 glass rounded-3xl p-2 relative overflow-hidden h-[480px]">
            <div className="absolute inset-2 rounded-[20px] bg-gradient-to-br from-slate-900 via-emerald-950/40 to-slate-900 overflow-hidden">
              ...
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 480" preserveAspectRatio="none">
                <path d="M80,400 Q300,300 400,250 Q550,180 720,80" stroke="#10b981" strokeWidth="3" strokeDasharray="8 6" fill="none" />
                ...
                <motion.g
                  ...
                  style={{ offsetPath: "path('M80,400 Q300,300 400,250 Q550,180 720,80')" } as any}>
          ...
          <div className="glass rounded-3xl p-6 flex flex-col">
            <div className="flex items-center gap-3">
              <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200" alt="Oumar Ba" className="h-14 w-14 rounded-full object-cover ring-2 ring-emerald-500/40" />
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <div className={`h-3 w-3 rounded-full ${s.done ? "bg-emerald-500" : "bg-muted"} ${s.current ? "ring-4 ring-emerald-500/30 animate-pulse" : ""}`} />
