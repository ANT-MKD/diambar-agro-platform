      ...
      <div className="relative mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link to="/register" className="inline-flex items-center gap-2 rounded-xl border border-primary/40 bg-primary/5 px-6 py-3.5 text-sm font-semibold text-primary hover:bg-primary/10 transition">
              Devenir partenaire
            </Link>
          </div>
          ...
          <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 5, repeat: Infinity, delay: 1 }}
            ...
            <div className="mt-3 h-32 rounded-xl bg-gradient-to-br from-primary/15 to-muted relative overflow-hidden">
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 200 120">
                ...
                <motion.circle r="6" fill="currentColor" stroke="#10b981" strokeWidth="2"
