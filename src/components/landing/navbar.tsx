      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className={`flex items-center justify-between rounded-2xl px-4 py-2.5 transition-all ${scrolled ? "glass-strong shadow-xl" : ""}`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/login" className="hidden md:inline-flex items-center text-sm font-medium px-3 py-2 rounded-lg hover:bg-accent transition">
              Se connecter
            </Link>
            <Link to="/register" className="hidden md:inline-flex items-center text-sm font-semibold px-4 py-2 rounded-xl bg-primary text-primary-foreground shadow-lg shadow-primary/20 hover:opacity-90 transition">
              Commencer
            </Link>
        ...
        {open && (
          <div className="lg:hidden mt-2 glass-strong rounded-2xl p-4 flex flex-col gap-2">
            ...
            <div className="flex gap-2 pt-2 border-t border-border">
              ...
              <Link to="/register" className="flex-1 text-center px-3 py-2 rounded-xl bg-primary text-primary-foreground text-sm font-semibold">Commencer</Link>
            </div>
